...
broker = Broker(app_env_vars.get_broker_url(), requests)
converter = Converter()
...
def home(city_code: str, startDate: str, endDate: str, qtGrowUp: str, qtChild: str):  # pragma: no cover
...
def home(city_code: str, hotel_code: str, startDate: str, endDate: str, qtGrowUp: str, qtChild: str):  # pragma: no cover
    search_data_request = SearchDataRequest(cityCodeRequest=city_code, startDateRequest=startDate,
                                            endDateRequest=endDate, qtGrowUpRequest=qtGrowUp,
